...
;( function( window ) {
	...
	SliderFx.prototype._init = function() {
		...
		if( this.itemsCount > 1 ) {
			...
			this.items.forEach( function( item ) {
				var svg = createSvg('<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 80 60" preserveAspectRatio="none"><path id="recto" d="' + self.options.paths.rect + '"/></svg>');
