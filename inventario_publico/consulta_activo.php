...
<html lang="es-CR">
  <head>
    ...
    <style>
    	...
    	:root {
		  --fondo1: #01579b !important;
		  --fondo2: #0277bd !important;
        ...
        <div class="site-content">
        			...
        			<div class="mdl-grid site-max-width" >
						<div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp page-content">
							...
							<div class="mdl-grid" style="width: 95%">
								...
								Bienvenido al sistema de consulta de activos SIUA, en esta página web usted puede consultar la información pública de los activos almacenados y administrados dentro de https://sae.siua.ac.cr.
								para ubicar la información de un activo, siga alguno de los siguientes pasos:
								<ul>
									<li>Digite el número de activo SIUA en la sección "N° activo"</li>
									<li>Escane el código QR con la información del activo SIUA</li>
									<li>Escane el código de barras del activo SIUA</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="modal-wrapper" id="vent_act_qr">
					  <div class="modal">
					    <div class="head">
								Escanear QR
					      <a class="btn-close" id="btn_cerrar_vent_act_qr" onclick="recargarPagina()">
					        <i class="fa fa-times" aria-hidden="true"></i>
					      </a>
					    </div>
					    <div class="content-modal">
					    	<div id="qr_seleccion_camara"></div>
