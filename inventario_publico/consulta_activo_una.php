...
<html lang="es-CR">
  <head>
    ...
    <style>
    	...
    	:root {
		  --fondo1: #cc071e !important;
		  --fondo2: #cc071e !important;
  ...
  <body id="top">
	...
	if($Id_Act!=''){
			...
			$sql ="SELECT
					...
					WHERE Activo_Act = '1' AND Id_INS_Act like '%".$Id_Act."%'";
				$res = seleccion($sql);
    ...
    <main class="mdl-layout__content">
        			...
        			<div class="mdl-grid site-max-width" >
						<div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp page-content">
							...
							<div class="mdl-card__title">
								<h1 class="mdl-card__title-text pruebaMediaQuery">BIENVENIDO</h1>
							</div>
							<!-- ****************** -->
							<!-- **** CONTENEDOR  * -->
							<!-- ****************** -->
							<div class="mdl-grid" style="width: 95%">
								...
								Bienvenido al sistema de consulta de activos SIUA-UNA, en esta página web usted puede consultar la información pública de los activos almacenados y administrados dentro de https://sae.siua.ac.cr para la Universidad Nacional	para ubicar la información de un activo, siga alguno de los siguientes pasos:
								<ul>
									<li>Digite el número de activo UNA en la sección "N° activo"</li>
									<li>Escane el código de barras del activo UNA</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="mdl-grid site-max-width" >
						<div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp page-content">
							...
							<div class="mdl-grid" style="width: 95%">
								...
								<!-- **  N° Activo   ** -->
								<!-- ****************** -->
								<div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-tablet mdl-cell--12-phone centrado">
									<form  id="form_busqueda_numero" method="get">
									    ...
									    <div class="mdl-textfield__expandable-holder">
									      <input class="mdl-textfield__input" type="text" id="txt_numero_activo" >
								...
								<!-- **   BARRAS     ** -->
								<!-- ****************** -->
								<div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-tablet mdl-cell--12-phone centrado" id="div_barras">
		...
		<script src="scripts/consulta_activo_una.js"></script>
		...
		<script src="scripts/barras/live_w_locator_una.js"></script>

		<!-- web_speech -->
		<script src="scripts/web_speech_una.js"></script>
  </body>
</html>
