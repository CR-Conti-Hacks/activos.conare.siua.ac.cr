<?php
	...
	$sql = "INSERT INTO tab_centros_trabajos (Nombre_CT, Diminutivo_CT, Logo_CT, Telefono_CT, Fax_CT, Direccion_CT, Correo_CT, Latitud_CT, Longitud_CT, Activo_CT) VALUES (".
	        "'".$txt_nombre."',".
            "'".$txt_diminutivo."',".
            "'".$file_logo."',".
			"'".$txt_telefono."',".
