...
<!-- ****************************************************************************************** -->
	<table class="centrado width40P" >
		...
		<tr>
			...
			<td>
				<textarea id="Descripcion_Mante_Act" name="Descripcion_Mante_Act" placeholder="Digite la descripción.." maxlength="250" onkeypress="ENTER(event,'agregarActivo()')"></textarea>
			</td>
		</tr>
		<tr>
			<td>Verificación</td>
