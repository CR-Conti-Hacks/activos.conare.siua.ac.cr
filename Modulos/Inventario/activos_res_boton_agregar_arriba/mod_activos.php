<?php
    ...
    $bs_anno               		= (isset($_GET['bs_anno']))            		? $_GET['bs_anno']             		: '';
...
<input type="hidden" 	id="or_Id_UGIT_Act" 			name="or_Id_UGIT_Act" 			value="<?=$or_Id_UGIT_Act?>" />
...
<!-- ****************************************************************************************** -->
	<table class="centrado width40P" >
		...
		<tr>
			<td>Activo UGIT</td>
			<td>
				<input type="text" name="Id_UGIT_Act" id="Id_UGIT_Act" maxlength="45" onkeypress="ENTER(event,'modificarActivo()')" placeholder="Digite el activo UGIT..." value="<?=$res_principal[0]['Id_UGIT_Act']?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
                <div id="div_Id_Factu_Act">
					<select id="Id_Factu_Act" name="Id_Factu_Act" >
                        <?php
		...
		<tr>
			...
			<td>
				<textarea id="Descripcion_Dese_Act" name="Descripcion_Dese_Act" placeholder="Digite la descripción.." maxlength="250" onkeypress="ENTER(event,'modificarActivo()')" ><?=$res_principal[0]['Descripcion_Dese_Act']?></textarea>
			</td>
		</tr>
		<tr>
			<td>Donación</td>
		...
		<tr>
			...
			<td>
				<textarea id="Descripcion_Dona_Act" name="Descripcion_Dona_Act" placeholder="Digite la descripción.." maxlength="250" onkeypress="ENTER(event,'modificarActivo()')"><?=$res_principal[0]['Descripcion_Dona_Act']?></textarea>
			</td>
		</tr>
        <tr>
			<td>Mantenimiento</td>
		...
		<tr>
			...
			<td>
				<textarea id="Descripcion_Mante_Act" name="Descripcion_Mante_Act" placeholder="Digite la descripción.." maxlength="250" onkeypress="ENTER(event,'modificarActivo()')"><?=$res_principal[0]['Descripcion_Mante_Act']?></textarea>
			</td>
		</tr>
		<tr>
			<td>Verificación</td>
...
<script>
        ...
        $('#td_Mantenimiento_Act').darkTooltip({
			  opacity:0.9,
			  size: 'large',
			  animation:'flipIn',
			  gravity:'west', // 
		...
		$('#Descripcion_Mante_Act').darkTooltip({
			  opacity:0.9,
			  size: 'large',
			  animation:'flipIn',
			  gravity:'west', // 
			  confirm:false,
			  theme:'dark',
			  content: "Se marca el activo como 'Mantenimiento', debe digitar una descripción del motivo (OPCIONAL)"
		});
