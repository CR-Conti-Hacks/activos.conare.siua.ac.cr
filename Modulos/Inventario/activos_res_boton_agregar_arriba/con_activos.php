...
<div id="Buscar" style="display:none;"  >
    <table class="width80P centrado" >
			...
			<td>
				<div id="div_Id_Factu_Act">
					...
					onchange="Buscar(
						...
						<?php
						if($bs_Numero_OC!=''){
							$sql ="SELECT Id_Factu,Numero_Factu FROM tab_facturas WHERE Activo_Factu = '1' AND  Id_OC_Factu=".$bs_Numero_OC;
							$res = seleccion($sql);
							for($i=0;$i<count($res);$i++){
						?>
		...
		<tr>
			...
			<td>
				<select id="bs_anno" name="bs_anno" onchange="Buscar(
								'',
								'Modulos/Inventario/activos/con_activos.php',
													   'pagina;inicio;'+
													   'bs_Id_Compromiso;'+
													   ...
													   document.getElementById('or_tipo_Nombre_Zonas_tmp').value+';');">
					<option value="0">[Seleccione]</option>
					<option value="DESC" <?php if($bs_anno =='DESC'){ echo 'selected="selected"';}?> >DESCONOCIDO</option>
					<option value="2012" <?php if($bs_anno =='2012'){ echo 'selected="selected"';}?>>2012</option>
					<option value="2013" <?php if($bs_anno =='2013'){ echo 'selected="selected"';}?>>2013</option>
					<option value="2014" <?php if($bs_anno =='2014'){ echo 'selected="selected"';}?>>2014</option>
					<option value="2015" <?php if($bs_anno =='2015'){ echo 'selected="selected"';}?>>2015</option>
					<option value="2016" <?php if($bs_anno =='2016'){ echo 'selected="selected"';}?>>2016</option>
					<option value="2017" <?php if($bs_anno =='2017'){ echo 'selected="selected"';}?>>2017</option>
