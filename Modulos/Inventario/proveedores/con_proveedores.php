<?php
	...
	$or_nom_proveedore_tipo 	= (isset($_GET['or_nom_proveedore_tipo'])) ? $_GET['or_nom_proveedore_tipo'] : 'ASC';
	...
	/************************   SQL PAGINACION  ********************************/
	/***************************************************************************/
    $sql ="SELECT COUNT(Id_Prove) AS Cant_Registros FROM tab_proveedores WHERE Activo_Prove = '1'";
				
	if($bs_nom_proveedore  != "" ){
		$sql.=" AND Nombre_Prove like '%".$bs_nom_proveedore."%'";
	}
    ...
    if ($or_nom_proveedore != "") {
	    $sql.=" ORDER BY ".$or_nom_proveedore.' '.$or_nom_proveedore_tipo;
	}else{
	    $sql.=" ORDER BY Nombre_Prove ASC";   
	}
...
<div id="Titulo_Adentro">
	<span class="Texto_Titulo" onclick="ActivaTextoTitulo();">Consultar Proveedores</span>
</div>
...
<div id="Buscar" style="display:none;"  >
    <table class="width200 centrado" >		
		<tr>
			...
			<td>
				<input type="text" name="bs_nom_proveedore" id="bs_nom_proveedore"  maxlength="50" value="<?=$bs_nom_proveedore?>" placeholder="Digite el nombre"
				onKeyPress="Buscar(
								event,
								'Modulos/Inventario/proveedores/con_proveedores.php',
								'bs_nom_proveedore;or_nom_proveedore;or_nom_proveedore_tipo;pagina;inicio;',
								document.getElementById('bs_nom_proveedore').value+';'+
                                document.getElementById('or_nom_proveedore').value+';'+
                                document.getElementById('or_nom_proveedore_tipo').value+';'+
                                '0;0;'
...
<!-- ***************************************************************************************-->
    <table class="centrado width40P">		
            <tr class="centrado">
                <thead>
                    <th>
                        <a onClick="Ordenar('Modulos/Inventario/proveedores/con_proveedores.php',
												   'or_nom_proveedore',
												   'Nombre_Prove',
												   'or_nom_proveedore_tipo',
												   'bs_nom_proveedore;pagina;inicio;',
                                                   document.getElementById('bs_nom_proveedore').value+';'+
                                                   '<?=$pagina.';'.$inicio.';'?>'
												);
								window.scrollTo(0,0);"-->
            ...
            <tr>
                ...
                onClick="MostrarVentana(
										this,
										10,
										'Modulos/Inventario/proveedores/mod_proveedores.php',
										'Id_Prove;pagina;inicio;bs_nom_proveedore;or_nom_proveedore;or_nom_proveedore_tipo;',
										'<?=$res[$i]['Id_Prove']?>;<?=$pagina?>;<?=$inicio?>;<?=$bs_nom_proveedore?>;<?=$or_nom_proveedore?>;<?=$or_nom_proveedore_tipo?>;')"
                ...
                <td class="centrado"><img src='img/SAE/eliminar.png' 
				 onClick="MostrarVentana(
										this,
										10,
										'Modulos/Inventario/proveedores/eli_proveedores.php',
										'Id_Prove;pagina;inicio;bs_nom_proveedore;or_nom_proveedore;or_nom_proveedore_tipo;',
										'<?=$res[$i]['Id_Prove']?>;<?=$pagina?>;<?=$inicio?>;<?=$bs_nom_proveedore?>;<?=$or_nom_proveedore?>;<?=$or_nom_proveedore_tipo?>;')"
...
<!-- ********************************************************************************************** -->
			<div class="Paginacion gris">
				<?php if ($pagina !=1){ ?>
					<a onClick="javascript:CargaPaginaMenu('Modulos/Inventario/proveedores/con_proveedores.php','pagina;inicio;or_nom_proveedore;or_nom_proveedore_tipo;bs_nom_proveedore;',
...
<!-- **************************       BOTONES      ******************************************** -->
<!-- ****************************************************************************************** -->
	<?php if(in_array("3041",$_SESSION['Permisos'])){ ?>
	<br/>
	<br/>
	<div class="centrado">
		<button class="boton" onclick="CargaPaginaMenu('Modulos/Inventario/proveedores/agr_proveedores.php','pagina;inicio;or_nom_proveedore;or_nom_proveedore_tipo;bs_nom_proveedore;mostrar_efecto;',
								'<?=$pagina?>;<?=$inicio?>;'
								+document.getElementById('or_nom_proveedore').value+';'
								+document.getElementById('or_nom_proveedore_tipo').value+';'
								+document.getElementById('bs_nom_proveedore').value+';1;');">Agregar Proveedor</button>
	</div>
	<?php } ?>
