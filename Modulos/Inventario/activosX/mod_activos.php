<?php
	...
	if($res_principal[0]['Foto_Act'] ==''){
		...
		$Foto_Per = $dominio.$ruta.'img/inventario/activos/'.$res_principal[0]['Foto_Act'];
	}
...
<!-- ****************************************************************************************** -->
	<table class="centrado width40P" >
		...
		<tr>
			...
			<td >
				<div style="width: 85%;" >
					<input type="file" id="Foto_Act" name="Foto_Act" class="dropify" data-default-file="<?=$Foto_Per?>" data-height="100" />    
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Descripción</td>
			<td>
				<textarea id="Descripcion_Act" name="Descripcion_Act" placeholder="Digite la descripción.." maxlength="250" onkeypress="ENTER(event,'modificarActivo()')"><?=$res_principal[0]['Descripcion_Act']?></textarea>
			</td>
		</tr>
